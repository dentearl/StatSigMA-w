...
bool compute_branch_parameters(Tree* node,Tree* parent,const blocks_type& blocks, double& K, double& lambda, double& H) {
  ...
  double score_dist[max_score-min_score+1];
...
double compute_pvalue_branch(Tree* node,Tree* parent,blocks_type& blocks,char* filename) {
  ...
  cout << "# XXXXX num block_num block_score score start end pvalue nearest_left nearest_right left_end right_end pv2 align_start align_end\n";
  ...
  for (int i=0;i<cur_seg;i++) {
    ...
    if ((i==0)&&(all_seg[i].align_start!=0)) {
      cout << "# Seg_fis " << i << "\t" << all_seg[i].block_num << "\t" << all_seg[i].block_score << "\t" << all_seg[i].score << "\t" << 0 << "\t" << all_seg[i].start-1 << "\t" << "1" << "\t" << "-1" << "\t";
    ...
    // Segment
    cout << "# Segment " << i << "\t" << all_seg[i].block_num << "\t" << all_seg[i].block_score << "\t" << all_seg[i].score << "\t" << all_seg[i].start << "\t" << all_seg[i].end << "\t" << all_seg[i].pv << "\t" << all_seg[i].nearest_left << "\t" << all_seg[i].nearest_right << "\t" << all_seg[i].left_end << "\t" << all_seg[i].right_end<< "\t" << all_seg[i].pv2 << "\t" << all_seg[i].align_start << "\t" << all_seg[i].align_end << endl;
    ...
    if ((i<cur_seg-1)&&(all_seg[i].align_end+1<all_seg[i+1].align_start)) {
      cout << "# Seg_nex " << i << "\t" << all_seg[i].block_num << "\t" << all_seg[i].block_score << "\t" << all_seg[i].score << "\t";
    ...
    if ((i==cur_seg-1)&&((all_seg[i].align_end) < (ALIGN_LEN-1))) {
      cout << "# Seg_end " << i << "\t" << all_seg[i].block_num << "\t" << all_seg[i].block_score << "\t" << all_seg[i].score << "\t" << all_seg[i].end+1 << "\t" << CHR_START+CHR_LEN-1 << "\t" << "1" << "\t";
      if (all_seg[i].nearest_left ==-1)
